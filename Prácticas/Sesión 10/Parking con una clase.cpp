...
class Parking{
	private:
		int limite_tramo_1, limite_tramo_2, 
      	limite_tramo_3, limite_tramo_4;
       
   	double tarifa_tramo_1, tarifa_tramo_2, 
      	tarifa_tramo_3, tarifa_tramo_4;
	...
	public:
		...
		void setLimite(int limite_1, int limite_2, int limite_3, int limite_4){
			limite_tramo_1 = limite_1;
			limite_tramo_2 = limite_2;
			limite_tramo_3 = limite_3;
			limite_tramo_4 = limite_4;
		}
		
		void setTarifa(double tarifa_1, double tarifa_2, double tarifa_3, double tarifa_4){
			tarifa_tramo_1 = tarifa_1;
			tarifa_tramo_2 = tarifa_2;
			tarifa_tramo_3 = tarifa_3;
			tarifa_tramo_4 = tarifa_4;
		}
